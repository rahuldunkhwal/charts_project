...
app.get("/statistics", async (req, res) => {
  try {
    ...
    const totalSale = await db.all(totalSaleQuery, params);
    const soldItems = await db.all(soldItemsQuery, params);
    const notSoldItems = await db.all(notSoldItemsQuery, params);
